...
export interface RlsFilterInfo {
  role?: string;
  scope?: 'station' | 'district' | 'state';
  station_id_applied?: boolean;
  heinous_excluded?: boolean;
  [key: string]: any;
}
...
export interface ExplanationContract {
  ...
  sql_executed?: string;
  sql_params_redacted?: string[];
  rls_filters_applied?: RlsFilterInfo;
