...
const NAV_LINKS = [
  ...
  { label: 'Sociological Insights', path: '/insights' },
  { label: 'Trends & Forecast',    path: '/screens/trends' },
  { label: 'Network & Risk',       path: '/screens/network' },
  { label: 'Case Support',         path: '/cases' },
];
